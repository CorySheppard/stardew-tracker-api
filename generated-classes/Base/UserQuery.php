...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'stardew-tracker', $modelName = '\\User', ?string $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, username, email, password_hash, created_at, updated_at FROM user WHERE id = :p0';
        try {
