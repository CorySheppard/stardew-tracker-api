...
class UserTableMap extends TableMap
{
     ...
     */
    public const DATABASE_NAME = 'stardew-tracker';
     ...
     */
    public const COL_PASSWORD_HASH = 'user.password_hash';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'user.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'user.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Username', 'Email', 'PasswordHash', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'username', 'email', 'passwordHash', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID, UserTableMap::COL_USERNAME, UserTableMap::COL_EMAIL, UserTableMap::COL_PASSWORD_HASH, UserTableMap::COL_CREATED_AT, UserTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id', 'username', 'email', 'password_hash', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Username' => 1, 'Email' => 2, 'PasswordHash' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'username' => 1, 'email' => 2, 'passwordHash' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID => 0, UserTableMap::COL_USERNAME => 1, UserTableMap::COL_EMAIL => 2, UserTableMap::COL_PASSWORD_HASH => 3, UserTableMap::COL_CREATED_AT => 4, UserTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'username' => 1, 'email' => 2, 'password_hash' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
